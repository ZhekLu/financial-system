...
bool LoanManager::credit_request(IUser *user, Bank *bank, size_t amount,
...
bool LoanManager::loan_request(IUser *user, Loan &l, bool is_credit) {

  Request r(is_credit ? Request::CREDIT : Request::INSTALLMENT, user->get_id(),
            l.get_id());
